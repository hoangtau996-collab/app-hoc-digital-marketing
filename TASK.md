...
- **Dải giới thiệu website & ứng dụng khác ở chân trang** — P MARCOM (trang tổng), P Healing (Tarot), Xin Xăm — Luận Quẻ, Capy Track (tracking công việc). Mở tab mới nên không đá học viên ra khỏi bài đang học; ảnh bìa để bản sao trong `public/apps/` (~260 KB cho cả bốn) và tải trễ; điện thoại vuốt ngang, máy tính bốn cột. Thẻ P MARCOM dùng ảnh sự kiện thay og:image vì og:image của site trùng bìa Academy ở đầu trang chủ.
