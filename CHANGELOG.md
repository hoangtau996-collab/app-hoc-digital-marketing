...
- Thành phần mới `PartnerAppsBanner` gắn vào footer, ngay trên dòng bản quyền: **P MARCOM — Website Tổng** (`pmarcom.com`) đứng đầu, rồi **P Healing — Tarot Online** (`healing.pmarcom.com`), **Xin Xăm — Luận Quẻ** (`xinxam.pmarcom.com`), **Capy Track — Tracking Công Việc** (`trackingtask.lethanhphong.vn`) và **Định Hướng Nghề Nghiệp** — trắc nghiệm DISC & Holland Code (`career.pmarcom.com`).
