...
- **Số liệu hiển thị bị thổi phồng và trộn sai đơn vị.** Ba lỗi độc lập cùng làm các con số trên giao diện lệch khỏi thực tế:
  - `TRAFFIC_BASELINE = 100` cộng thẳng vào mọi chỗ hiển thị lượt truy cập. Trang vừa mở đã hiện "103 lượt" trong khi chỉ có 3 lượt thật. Đã đặt về `0`.
